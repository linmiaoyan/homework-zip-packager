...
const statStages = {
    intelligence: [
        ...
        { min: 90, max: 119, name: '旷世奇才', icon: '💡', color: '#f39c12', description: '百年难遇，天赋异禀' },
        { min: 120, max: 149, name: '智慧圣人', icon: '👴', color: '#1abc9c', description: '洞察世事，智慧超群' },
        { min: 150, max: 179, name: '先知', icon: '🔮', color: '#e91e63', description: '预知未来，通晓古今' },
        { min: 180, max: 200, name: '智慧之神', icon: '✨', color: '#00bcd4', description: '智慧达到神的境界' }
    ],
    strength: [
        ...
        { min: 90, max: 119, name: '绝世猛将', icon: '⚔️', color: '#f39c12', description: '万人敌' },
        { min: 120, max: 149, name: '武神', icon: '🛡️', color: '#1abc9c', description: '武勇无双，无人能敌' },
        { min: 150, max: 179, name: '战神', icon: '⚡', color: '#e91e63', description: '征战四方，所向披靡' },
        { min: 180, max: 200, name: '泰坦', icon: '🏔️', color: '#00bcd4', description: '拥有泰坦般的力量' }
    ],
    charm: [
        ...
        { min: 90, max: 119, name: '倾国倾城', icon: '👑', color: '#f39c12', description: '绝世容颜' },
        { min: 120, max: 149, name: '绝代佳人', icon: '💃', color: '#1abc9c', description: '风华绝代，倾倒众生' },
        { min: 150, max: 179, name: '魅惑之神', icon: '💋', color: '#e91e63', description: '一笑倾城，再笑倾国' },
        { min: 180, max: 200, name: '爱神', icon: '💕', color: '#00bcd4', description: '拥有爱神般的魅力' }
    ],
    wealth: [
        ...
        { min: 90, max: 119, name: '首富', icon: '👑', color: '#f39c12', description: '富可敌国' },
        { min: 120, max: 149, name: '世界首富', icon: '🌍', color: '#1abc9c', description: '财富遍布全球' },
        { min: 150, max: 179, name: '金融巨鳄', icon: '🦈', color: '#e91e63', description: '掌控世界经济' },
        { min: 180, max: 200, name: '财神', icon: '🤑', color: '#00bcd4', description: '财富超越凡人想象' }
    ],
    health: [
        ...
        { min: 90, max: 119, name: '金刚不坏', icon: '🦸', color: '#f39c12', description: '百毒不侵' },
        { min: 120, max: 149, name: '长生不老', icon: '🧓', color: '#1abc9c', description: '青春永驻' },
        { min: 150, max: 179, name: '不死之身', icon: '💀', color: '#e91e63', description: '近乎不死' },
        { min: 180, max: 200, name: '永生', icon: '🌟', color: '#00bcd4', description: '获得永生' }
    ],
    luck: [
        ...
        { min: 90, max: 119, name: '天命之子', icon: '🌟', color: '#f39c12', description: '天选之人' },
        { min: 120, max: 149, name: '幸运女神', icon: '🧚', color: '#1abc9c', description: '幸运女神眷顾' },
        { min: 150, max: 179, name: '命运主宰', icon: '🔮', color: '#e91e63', description: '掌控自己的命运' },
        { min: 180, max: 200, name: '命运之神', icon: '⚡', color: '#00bcd4', description: '成为命运的化身' }
    ]
};
...
const randomEvents = [
    ...
    // 节日事件
    {
        minAge: 5, maxAge: 70, title: '🎉 春节红包',
        text: '春节到了，长辈们给了你很多红包！',
        choices: [
            { text: '把红包交给父母保管', effects: { charm: 3, wealth: 2 } },
            { text: '自己存起来', effects: { wealth: 4, intelligence: 1 } },
            { text: '用红包买礼物送给家人', effects: { charm: 4, wealth: -1 } }
        ]
    },
    // 更多正面事件
    {
        minAge: 10, maxAge: 70, title: '🌟 意外发现',
        text: '你在整理旧物时，发现了一个被遗忘的盒子，里面有一些值钱的东西！',
        choices: [
            { text: '交给失主/家人', effects: { charm: 3, luck: 2 } },
            { text: '自己留着', effects: { wealth: 5, charm: -1 } }
        ]
    },
    {
        minAge: 15, maxAge: 60, title: '💼 升职加薪',
        text: '你的努力得到了认可，老板给你升职加薪了！',
        choices: [
            { text: '请同事们吃饭庆祝', effects: { charm: 4, wealth: -2 } },
            { text: '低调谦虚，继续努力', effects: { intelligence: 3, luck: 2 } }
        ]
    },
    {
        minAge: 5, maxAge: 70, title: '🎁 意外礼物',
        text: '一个神秘的包裹寄到了你家，里面是一份惊喜礼物！',
        choices: [
            { text: '开心收下，感谢送礼物的人', effects: { charm: 3, luck: 2 } },
            { text: '好奇是谁送的，调查一下', effects: { intelligence: 2, luck: 1 } }
        ]
    },
    {
        minAge: 12, maxAge: 50, title: '🎵 街头艺人',
        text: '你在街头遇到了一位才华横溢的艺人，他的表演让你深受感动。',
        choices: [
            { text: '慷慨打赏', effects: { charm: 3, wealth: -1, luck: 2 } },
            { text: '驻足欣赏，鼓掌称赞', effects: { charm: 2, health: 1 } }
        ]
    },
    {
        minAge: 20, maxAge: 65, title: '🏠 房租减免',
        text: '你的房东决定给你减免一个月的房租，说是感谢你一直按时交租。',
        choices: [
            { text: '请房东吃顿饭表示感谢', effects: { charm: 3, wealth: -1 } },
            { text: '把钱存起来', effects: { wealth: 3, intelligence: 1 } }
        ]
    },
    {
        minAge: 8, maxAge: 60, title: '📚 图书馆奇遇',
        text: '你在图书馆发现了一本珍贵的绝版书，里面夹着一张古老的书签。',
        choices: [
            { text: '把书签交给图书馆', effects: { charm: 2, intelligence: 2 } },
            { text: '珍藏书签作为纪念', effects: { luck: 3, intelligence: 1 } }
        ]
    },
    {
        minAge: 18, maxAge: 55, title: '💖 陌生人的善意',
        text: '你在外面遇到了困难，一位陌生人主动伸出援手帮助了你。',
        choices: [
            { text: '真诚感谢并记下联系方式', effects: { charm: 3, luck: 2 } },
            { text: '铭记这份善意，传递爱心', effects: { charm: 2, luck: 3 } }
        ]
    },
    {
        minAge: 5, maxAge: 70, title: '🌈 美丽的彩虹',
        text: '雨后天空出现了一道美丽的彩虹，让你心情格外舒畅。',
        choices: [
            { text: '拍下来分享给朋友', effects: { charm: 2, luck: 2 } },
            { text: '静静欣赏，感受美好', effects: { health: 3, intelligence: 1 } }
        ]
    },
    {
        minAge: 25, maxAge: 60, title: '📈 股票大涨',
        text: '你之前投资的股票大涨，收益颇丰！',
        choices: [
            { text: '及时卖出，落袋为安', effects: { wealth: 6, intelligence: 1 } },
            { text: '继续持有，期待更高收益', effects: { wealth: 3, luck: 2 } }
        ]
    },
    {
        minAge: 10, maxAge: 70, title: '🎨 艺术灵感',
        text: '你突然获得了强烈的艺术灵感，创作出了一件很棒的作品！',
        choices: [
            { text: '参加比赛或展览', effects: { charm: 4, intelligence: 2 } },
            { text: '自己珍藏', effects: { health: 2, luck: 2 } }
        ]
    },
    {
        minAge: 18, maxAge: 50, title: '✈️ 免费机票',
        text: '你中了一张免费机票，可以去任何你想去的地方！',
        choices: [
            { text: '去梦想中的目的地旅行', effects: { health: 4, charm: 2, wealth: -2 } },
            { text: '转赠给家人朋友', effects: { charm: 4, luck: 2 } }
        ]
    },
    {
        minAge: 8, maxAge: 60, title: '🐱 流浪猫报恩',
        text: '你曾经救助过的一只流浪猫，竟然带回了一只受伤的小鸟给你！',
        choices: [
            { text: '把小鸟也带回家照顾', effects: { charm: 3, luck: 2 } },
            { text: '联系动物救助站', effects: { charm: 2, intelligence: 1 } }
        ]
    },
    {
        minAge: 20, maxAge: 65, title: '💡 创意点子',
        text: '你突然想到了一个很棒的创业点子，朋友们都觉得很有前途！',
        choices: [
            { text: '立刻开始筹备', effects: { intelligence: 3, luck: 3 } },
            { text: '先做市场调研', effects: { intelligence: 4, wealth: 1 } }
        ]
    },
    // 节日事件
    {
...
function startLife() {
    ...
    currentYearEventCount = 0; // 重置年份事件计数
    buildEventQueue();
    updateGameUI();
    showNextEvent();
}
...
let currentYearEventCount = 0; // 记录当前年份发生的事件数量

function resetYearEventCount() {
...
function showNextEvent() {
    ...
    // 同一年最多发生3个额外事件（不包括主线事件）
    let maxExtraEventsPerYear = 3;

    // 增加正面事件发生概率 - 属性阶段事件（40%概率）
    if (currentYearEventCount < maxExtraEventsPerYear && Math.random() < 0.4) {
    ...
    // 增加随机事件概率（50%概率）
    let mightInsertRandom = Math.random() < 0.5;
    if (currentYearEventCount < maxExtraEventsPerYear && mightInsertRandom) {
    ...
    // 挫折事件（降低到5%概率）
    let mightInsertSetback = Math.random() < 0.05;
    if (currentYearEventCount < maxExtraEventsPerYear && mightInsertSetback && nextEvent.age > player.age) {
...
function checkAchievements() {
    ...
    // 高级属性成就 (120+)
    if (player.wealth >= 120 && !player.achievements.includes('世界首富')) {
        player.achievements.push('世界首富');
        newAchievements.push('世界首富');
    }
    if (player.intelligence >= 120 && !player.achievements.includes('智慧圣人')) {
        player.achievements.push('智慧圣人');
        newAchievements.push('智慧圣人');
    }
    if (player.charm >= 120 && !player.achievements.includes('绝代佳人')) {
        player.achievements.push('绝代佳人');
        newAchievements.push('绝代佳人');
    }
    if (player.health >= 120 && !player.achievements.includes('长生不老')) {
        player.achievements.push('长生不老');
        newAchievements.push('长生不老');
    }
    if (player.strength >= 120 && !player.achievements.includes('武神')) {
        player.achievements.push('武神');
        newAchievements.push('武神');
    }
    if (player.luck >= 120 && !player.achievements.includes('幸运女神')) {
        player.achievements.push('幸运女神');
        newAchievements.push('幸运女神');
    }

    // 顶级属性成就 (150+)
    if (player.wealth >= 150 && !player.achievements.includes('金融巨鳄')) {
        player.achievements.push('金融巨鳄');
        newAchievements.push('金融巨鳄');
    }
    if (player.intelligence >= 150 && !player.achievements.includes('先知')) {
        player.achievements.push('先知');
        newAchievements.push('先知');
    }
    if (player.charm >= 150 && !player.achievements.includes('魅惑之神')) {
        player.achievements.push('魅惑之神');
        newAchievements.push('魅惑之神');
    }
    if (player.health >= 150 && !player.achievements.includes('不死之身')) {
        player.achievements.push('不死之身');
        newAchievements.push('不死之身');
    }
    if (player.strength >= 150 && !player.achievements.includes('战神')) {
        player.achievements.push('战神');
        newAchievements.push('战神');
    }
    if (player.luck >= 150 && !player.achievements.includes('命运主宰')) {
        player.achievements.push('命运主宰');
        newAchievements.push('命运主宰');
    }

    // 神级属性成就 (180+)
    if (player.wealth >= 180 && !player.achievements.includes('财神')) {
        player.achievements.push('财神');
        newAchievements.push('财神');
    }
    if (player.intelligence >= 180 && !player.achievements.includes('智慧之神')) {
        player.achievements.push('智慧之神');
        newAchievements.push('智慧之神');
    }
    if (player.charm >= 180 && !player.achievements.includes('爱神')) {
        player.achievements.push('爱神');
        newAchievements.push('爱神');
    }
    if (player.health >= 180 && !player.achievements.includes('永生')) {
        player.achievements.push('永生');
        newAchievements.push('永生');
    }
    if (player.strength >= 180 && !player.achievements.includes('泰坦')) {
        player.achievements.push('泰坦');
        newAchievements.push('泰坦');
    }
    if (player.luck >= 180 && !player.achievements.includes('命运之神')) {
        player.achievements.push('命运之神');
        newAchievements.push('命运之神');
    }
    ...
    if (player.children >= 3 && !player.achievements.includes('多子多福')) {
        player.achievements.push('多子多福');
        newAchievements.push('多子多福');
    }
    if (player.career !== '无' && !player.achievements.includes('职场精英')) {
        player.achievements.push('职场精英');
        newAchievements.push('职场精英');
    }
    if (player.careerLevel >= 5 && !player.achievements.includes('行业领袖')) {
        player.achievements.push('行业领袖');
        newAchievements.push('行业领袖');
    }
    ...
    let allAbove100 = player.intelligence >= 100 && player.strength >= 100 && player.charm >= 100 && player.wealth >= 100 && player.health >= 100 && player.luck >= 100;
    if (allAbove100 && !player.achievements.includes('全能选手')) {
        player.achievements.push('全能选手');
        newAchievements.push('全能选手');
    }
    let allAbove150 = player.intelligence >= 150 && player.strength >= 150 && player.charm >= 150 && player.wealth >= 150 && player.health >= 150 && player.luck >= 150;
    if (allAbove150 && !player.achievements.includes('半神')) {
        player.achievements.push('半神');
        newAchievements.push('半神');
    }
    let allAbove180 = player.intelligence >= 180 && player.strength >= 180 && player.charm >= 180 && player.wealth >= 180 && player.health >= 180 && player.luck >= 180;
    if (allAbove180 && !player.achievements.includes('真神')) {
        player.achievements.push('真神');
        newAchievements.push('真神');
    }

    // 年龄成就
    if (player.age >= 50 && !player.achievements.includes('知天命')) {
        player.achievements.push('知天命');
        newAchievements.push('知天命');
    }
    if (player.age >= 70 && !player.achievements.includes('古稀之年')) {
        player.achievements.push('古稀之年');
        newAchievements.push('古稀之年');
    }
    if (player.age >= 80 && !player.achievements.includes('耄耋之年')) {
        player.achievements.push('耄耋之年');
        newAchievements.push('耄耋之年');
    }
    if (player.age >= 90 && !player.achievements.includes('鲐背之年')) {
        player.achievements.push('鲐背之年');
        newAchievements.push('鲐背之年');
    }
    if (player.age >= 100 && !player.achievements.includes('人瑞')) {
        player.achievements.push('人瑞');
        newAchievements.push('人瑞');
    }
